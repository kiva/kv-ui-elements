...
} from '../distributionModels';
import { mockAllFacets } from './fixtures/mockLoanSearchData';

describe('distributionModels.ts', () => {
	describe('default', () => {
		...
		describe('getValidatedSearchState', () => {
			it('should handle undefined', () => {
				const result = distributionModels.getValidatedSearchState({}, undefined);

				expect(result).toEqual({ distributionModel: null });
			});

			it('should handle empty', () => {
				const result = distributionModels.getValidatedSearchState({}, mockAllFacets);
			...
			it('should validate distribution model', () => {
				...
				const result = distributionModels.getValidatedSearchState(state, mockAllFacets);
		...
		describe('getFilterFromQuery', () => {
			it('it should handle undefined facets', () => {
				...
				const result = distributionModels.getFilterFromQuery(query, undefined);
			...
			it('it should get filter', () => {
				...
				const result = distributionModels.getFilterFromQuery(query, mockAllFacets);
		...
		describe('getQueryFromFilter', () => {
			it('should push distribution model', () => {
				...
				const result = distributionModels.getQueryFromFilter(state);
