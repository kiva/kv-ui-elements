import flexibleFundraisingEnabled, {
	...
	facetsKey,
	typeName,
} from '../flexibleFundraisingEnabled';

describe('flexibleFundraisingEnabled.ts', () => {
	describe('default', () => {
		describe('getOptions', () => {
		...
		describe('getFlssFilter', () => {
			it('should get FLSS filter', () => {
				...
				expect(flexibleFundraisingEnabled.getFlssFilter({ [facetsKey]: true })).toEqual({ [facetsKey]: { eq: true } });
			});
		});
		...
		describe('getValidatedSearchState', () => {
			it('should get validated search state', () => {
				...
				expect(flexibleFundraisingEnabled.getValidatedSearchState({})).toEqual({ [facetsKey]: null });
				expect(flexibleFundraisingEnabled.getValidatedSearchState({ [facetsKey]: true })).toEqual({ [facetsKey]: true });
				expect(flexibleFundraisingEnabled.getValidatedSearchState({ [facetsKey]: 'asd' })).toEqual({ [facetsKey]: null });
			});
		});
		...
		describe('getQueryFromFilter', () => {
			it('should get query object', () => {
				...
				expect(flexibleFundraisingEnabled.getQueryFromFilter({ [facetsKey]: false })).toEqual({ [facetsKey]: 'false' });
			});
		});
	});
});
