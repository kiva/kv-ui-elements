...
describe('genders.ts', () => {
	describe('default', () => {
		...
		describe('getValidatedSearchState', () => {
			it('should handle undefined', () => {
				const result = genders.getValidatedSearchState({}, undefined);

				expect(result).toEqual({ gender: null });
			});

			it('should handle empty', () => {
				const result = genders.getValidatedSearchState({}, mockAllFacets);
			...
			it('should validate gender', () => {
				...
				const result = genders.getValidatedSearchState(state, mockAllFacets);
		...
		describe('getFilterFromQuery', () => {
			it('it should handle undefined facets', () => {
				...
				const result = genders.getFilterFromQuery(query, undefined);
			...
			it('it should get filter', () => {
				...
				const result = genders.getFilterFromQuery(query, mockAllFacets);
		...
		describe('getQueryFromFilter', () => {
			it('should push gender', () => {
				...
				const result = genders.getQueryFromFilter(state);
