import sortOptions, { visibleFLSSSortOptions, formatSortOptions } from '../sortOptions';
import { STANDARD_QUERY_TYPE, FLSS_QUERY_TYPE } from '../filterOptionUtils';
import { mockAllFacets, mockState } from './fixtures/mockLoanSearchData';

describe('sortOptions.ts', () => {
	describe('default', () => {
