...
} from '../lenderRepaymentTerms';
import { createMinMaxRange } from '../minMaxRangeUtils';

describe('lenderRepaymentTerms.ts', () => {
	describe('default', () => {
		describe('getFilterChips', () => {
			it('should handle undefined', () => {
				expect(lenderRepaymentTerms.getFilterChips({})).toEqual([]);
			});
		...
		describe('getValidatedSearchState', () => {
			it('should handle undefined', () => {
				const result = lenderRepaymentTerms.getValidatedSearchState({});
			...
			it('should validate lender repayment term', () => {
				...
				const result = lenderRepaymentTerms.getValidatedSearchState(state);
		...
		describe('getFilterFromQuery', () => {
			it('it should get filter', () => {
				...
				const result = lenderRepaymentTerms.getFilterFromQuery(query);
		...
		describe('getQueryFromFilter', () => {
			it('should push lender term', () => {
				...
				const result = lenderRepaymentTerms.getQueryFromFilter(state);
