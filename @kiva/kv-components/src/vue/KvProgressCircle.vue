...
export default {
    ...
    setup(props) {
        ...
        const strokeDashoffset = computed(() => circumference.value - (props.value / 100) * circumference.value * props.arcScale);
        
        const backgroundStrokeDashoffset = computed(() => circumference.value - 1 * circumference.value * props.arcScale);
