...
The component supports five predefined themes from `@kiva/kv-tokens`:
...
- **Theme Selection**: Choose themes that align with your content's purpose - greenLight/greenDark for positive actions, marigoldLight for attention, stoneLight for neutral content
...
- For the dark theme (greenDark), ensure text colors provide adequate contrast
