...
Five pre-defined themes provide visual variety:

- **default**: Standard Kiva branding
- **ecoGreenLight** / **ecoGreenDark**: Green tones for eco-related content (ecoGreenDark is most commonly used)
- **ecoLightMarigold**: Warm marigold theme
- **ecoStoneLight**: Neutral stone tone
