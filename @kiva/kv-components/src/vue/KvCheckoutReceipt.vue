...
export default {
	...
	setup() {
		...
		const printIcon = computed(() => mdiPrinter);
...
.section {
	@apply tw-border-b tw-border-t-0 tw-border-tertiary tw-p-1;
	display: block;
	overflow: hidden;
	@media print {
...
.checkout-receipt__headline {
	text-align: center;
	margin-bottom: 1.5rem;
}

.checkout-receipt__item-list {
	list-style: none;
	margin: 0;
	width: 100%;
}
...
.payments__type-title,
.payments__type-amount {
	flex: 1;
}
